...
namespace AppUtilityLib
{
	...
	public static class Encryption
    {
        ...
        /// </summary>
        public static string EncryptionKey = "Mom365";
        ...
        {
            if (encryptionKey == null)
                throw new ArgumentException("MissingEncryptionKey");
        ...
        public static string DecryptStringSafe(string encryptedString)
        {
            try
            {
